...
exports.activate = (context) => {
      ...
      context.subscriptions.push(vscode.languages.registerDocumentSymbolProvider('ez80-asm', refsNDefs))
      context.subscriptions.push(vscode.languages.registerWorkspaceSymbolProvider(refsNDefs))
      ...
      // vscode.workspace.onDidChangeConfiguration((event) => { TODO })
}
exports.deactivate = () => { }